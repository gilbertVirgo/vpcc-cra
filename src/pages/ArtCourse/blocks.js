				...
				<div className="max-w-2xl flex flex-col gap-8">
					...
					<div className="flex flex-col gap-3 px-8" id="details">
						...
						<ul className="flex flex-col gap-1 pl-6 list-disc">
							...
							<li>
								<strong>Included:</strong> Meals provided each
								week
							</li>
					...
					<div className="flex flex-col gap-3 px-8" id="sign-up">
						...
						<div className="flex flex-col gap-2">
							<p>
								<strong>Places are limited</strong>, so sign up
								soon if you&apos;d like to join us.
							</p>

							<p>
								Text <strong>&apos;ART&apos;</strong> with your
								name to{" "}
								<a href="sms:+447397543132">07397 543 132</a>.
							</p>
						</div>

						<div className="flex flex-col md:flex-row gap-3">
							<Button href="tel:+447397543132">Call us</Button>

							<Button href="/connect">Contact via email</Button>
						</div>
					</div>

					<div className="flex flex-col gap-3 px-8">
						<p>
							No experience needed — just curiosity and a
